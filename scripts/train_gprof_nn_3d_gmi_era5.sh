...
gprof_nn train 3D  GMI ERA5 ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_neurons_head 256 --n_neurons_body  512 --n_blocks 5 --n_layers_head 4 --device cuda:1 --targets ${TARGETS} --type qrnn_exp --batch_size 8 --n_epochs 5 --learning_rate 0.0001 --activation GELU --no_validation
