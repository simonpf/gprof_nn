...
MODEL_PATH=/gdata1/simon/gprof_nn/models/gprof_nn_3d_gmi_era5_bn.pckl
...
gprof_nn train 3D  GMI ERA5 ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_neurons_head 256 --n_neurons_body  512 --n_blocks 5 --n_layers_head 4 --device cuda:0 --targets ${TARGETS} --type qrnn_exp --batch_size 8 --n_epochs 20 --learning_rate 0.0001 --activation GELU --no_validation
