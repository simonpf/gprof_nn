...
python train_simulator.py MHS ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_features_body 256 --n_features_head 256 --n_layers_head 4  --device cuda:0 --batch_size 8
