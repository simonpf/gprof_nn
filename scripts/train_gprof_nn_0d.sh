...
MODEL_PATH=${HOME}/src/gprof_nn/models/gprof_nn_0d_gmi_era5.pckl
...
gprof_nn train 0D GMI ERA5 ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_neurons_body 256 --n_layers_body 8 --n_neurons_head 128 --n_layers_head 4 --activation GELU --residuals hyper --device cuda:1 --targets ${TARGETS} --type qrnn_exp --batch_size 512 --n_epochs 10 10 --learning_rate 0.0005 0.0001
