...
python train_gprof_nn_0d.py  ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_neurons 256 --n_layers_body 6 --n_layers_head 2 --device cuda:1 --targets ${TARGETS} --type qrnn_exp --batch_size 1024
