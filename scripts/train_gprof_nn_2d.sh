...
python train_gprof_nn_2d.py  ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_neurons 256 --n_blocks 2 --n_layers_head 2 --device cuda:0 --targets ${TARGETS} --type qrnn --batch_size 4
