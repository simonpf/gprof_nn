...
MODEL_PATH=${HOME}/src/gprof_nn/models/gprof_nn_3d_mhs_era5_new.pckl
...
gprof_nn train 3D  MHS_NOAA19_FULL ERA5 ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_neurons_head 256 --n_neurons_body  512 --n_blocks 4 --n_layers_head 4 --device cuda:1 --targets ${TARGETS} --type qrnn_exp --batch_size 8 --n_epochs 10 --learning_rate 0.0005 --activation GELU
