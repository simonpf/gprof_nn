...
MODEL_PATH=${HOME}/src/gprof_nn/models/gprof_nn_2d_gmi_era5_na.pckl
...
gprof_nn train 2D  GMI ERA5 ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_neurons_head 256 --n_neurons_body  512 --n_blocks 6 --n_layers_head 4 --device cuda:1 --targets ${TARGETS} --type drnn --batch_size 4 --n_epochs 30 --learning_rate 0.0005 --activation GELU
