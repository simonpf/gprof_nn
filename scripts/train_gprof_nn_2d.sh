...
python train_gprof_nn_2d.py  GMI ${TRAINING_DATA} ${VALIDATION_DATA} ${MODEL_PATH} --n_features_head 256 --n_features_body  256 --n_blocks 8 --n_layers_head 4 --device cuda:1 --targets ${TARGETS} --type qrnn_exp --batch_size 8
